...
# 2. Instantiate your robot object
...
with robot:
    ...
    # can be held/posed freely by hand while we read back its position.
    robot.bus.disable_torque()

    print("Connected! Torque disabled - hold the arm in its home pose.")
    print("Reading observations (Press Ctrl+C to stop)...")

    try:
        while True:
            # 4. Call get_observation() to fetch the dictionary of positions
